  ...
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      {!open && !hoveredCountry && countryNames.length > 0 && (
        <div className="pointer-events-none absolute bottom-6 left-1/2 z-10 -translate-x-1/2 whitespace-nowrap rounded-full bg-ink/80 px-4 py-2 text-sm text-white shadow-float dark:bg-overlayDark dark:shadow-float-dark">
